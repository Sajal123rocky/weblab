...
var app=express()
var MongoClient=require('mongodb').MongoClientapp.get('/',function(req,res) {
...
{
if(!err) {
res.end("<p>Successfulinsertion</p><br><a href='/'>Insert</a><br><ahref='/update'>Update Data</a>")
}
})
}
})
...
app.get('/results',function(req,res) {MongoClient.connect("mongodb://127.0.0.1:27017/nodedb",function(err,db) {
if(!err) {
